export const departments = [
  ...
  { value: 7, label: "Отдел продаж" },
  { value: 8, label: "Отдел логистики" },
  { value: 9, label: "Отдел качества" },
  { value: 10, label: "CEO" },
...
export const positions = [
  ...
  { value: 9, label: "Маркетолог" },
  { value: 10, label: "Копирайтер" },
  { value: 11, label: "Оператор склада" },
  { value: 12, label: "Водитель" },
  { value: 13, label: "Сотрудник" },
  { value: 14, label: "Начальник отдела" },
  { value: 15, label: "Инженер" },
